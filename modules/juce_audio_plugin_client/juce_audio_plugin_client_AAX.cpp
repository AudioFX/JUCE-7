...
static_assert(AAX_SDK_CURRENT_REVISION >= AAX_SDK_2p4p0_REVISION,
              "JUCE requires AAX SDK version 2.4.0 or higher");

#if defined(AAX_SDK_2p5p0_REVISION) &&                                         \
  AAX_SDK_2p5p0_REVISION <= AAX_SDK_CURRENT_REVISION
...
{
static int32
getAAXParamHash(AAX_CParamID paramID) noexcept
{
    int32 result = 0;
...
static void
check([[maybe_unused]] AAX_Result result)
{
...
stemFormatForAmbisonicOrder(int order)
{
    switch (order)
    {
        case 1:
...
static AAXChannelStreamOrder aaxChannelOrder[] = {
    ...
    { AAX_eStemFormat_Stereo,
      { AudioChannelSet::left, AudioChannelSet::right } },
...
static AAX_EStemFormat aaxFormats[] = {
    AAX_eStemFormat_Mono,       AAX_eStemFormat_Stereo,
    AAX_eStemFormat_LCR,        AAX_eStemFormat_LCRS,
    ...
    AAX_eStemFormat_7_1_SDDS,   AAX_eStemFormat_7_0_DTS,
    AAX_eStemFormat_7_1_DTS,    AAX_eStemFormat_7_0_2,
    AAX_eStemFormat_7_1_2,      AAX_eStemFormat_Ambi_1_ACN,
    AAX_eStemFormat_Ambi_2_ACN, AAX_eStemFormat_Ambi_3_ACN,
#if JUCE_AAX_SDK_2p5p0
    AAX_eStemFormat_5_0_2,      AAX_eStemFormat_5_1_2,
    AAX_eStemFormat_5_0_4,      AAX_eStemFormat_5_1_4,
    AAX_eStemFormat_7_0_4,      AAX_eStemFormat_7_1_4,
    AAX_eStemFormat_7_0_6,      AAX_eStemFormat_7_1_6,
    AAX_eStemFormat_9_0_4,      AAX_eStemFormat_9_1_4,
    AAX_eStemFormat_9_0_6,      AAX_eStemFormat_9_1_6,
    AAX_eStemFormat_Ambi_4_ACN, AAX_eStemFormat_Ambi_5_ACN,
    AAX_eStemFormat_Ambi_6_ACN, AAX_eStemFormat_Ambi_7_ACN,
#endif
};

static AAX_EStemFormat
getFormatForAudioChannelSet(const AudioChannelSet& set,
                            bool ignoreLayout) noexcept
{
    // if the plug-in ignores layout, it is ok to convert between formats only
    // by their numchannnels
    if (ignoreLayout)
    {
        ...
        const auto maybeAmbisonicOrder =
    ...
    if (set == AudioChannelSet::disabled())
        return AAX_eStemFormat_None;
    if (set == AudioChannelSet::mono())
        return AAX_eStemFormat_Mono;
    if (set == AudioChannelSet::stereo())
        return AAX_eStemFormat_Stereo;
    if (set == AudioChannelSet::createLCR())
        return AAX_eStemFormat_LCR;
    if (set == AudioChannelSet::createLCRS())
        return AAX_eStemFormat_LCRS;
    if (set == AudioChannelSet::quadraphonic())
        return AAX_eStemFormat_Quad;
    if (set == AudioChannelSet::create5point0())
        return AAX_eStemFormat_5_0;
    if (set == AudioChannelSet::create5point1())
        return AAX_eStemFormat_5_1;
    if (set == AudioChannelSet::create6point0())
        return AAX_eStemFormat_6_0;
    if (set == AudioChannelSet::create6point1())
        return AAX_eStemFormat_6_1;
    if (set == AudioChannelSet::create7point0())
        return AAX_eStemFormat_7_0_DTS;
    if (set == AudioChannelSet::create7point1())
        return AAX_eStemFormat_7_1_DTS;
    if (set == AudioChannelSet::create7point0SDDS())
        return AAX_eStemFormat_7_0_SDDS;
    if (set == AudioChannelSet::create7point1SDDS())
        return AAX_eStemFormat_7_1_SDDS;
    if (set == AudioChannelSet::create7point0point2())
        return AAX_eStemFormat_7_0_2;
    if (set == AudioChannelSet::create7point1point2())
        return AAX_eStemFormat_7_1_2;

#if JUCE_AAX_SDK_2p5p0
    if (set == AudioChannelSet::create5point0point2())
        return AAX_eStemFormat_5_0_2;
    if (set == AudioChannelSet::create5point1point2())
        return AAX_eStemFormat_5_1_2;
    if (set == AudioChannelSet::create5point0point4())
        return AAX_eStemFormat_5_0_4;
    if (set == AudioChannelSet::create5point1point4())
        return AAX_eStemFormat_5_1_4;
    if (set == AudioChannelSet::create7point0point4())
        return AAX_eStemFormat_7_0_4;
    if (set == AudioChannelSet::create7point1point4())
        return AAX_eStemFormat_7_1_4;
    if (set == AudioChannelSet::create7point0point6())
        return AAX_eStemFormat_7_0_6;
    if (set == AudioChannelSet::create7point1point6())
        return AAX_eStemFormat_7_1_6;
    if (set == AudioChannelSet::create9point0point4())
        return AAX_eStemFormat_9_0_4;
    if (set == AudioChannelSet::create9point1point4())
        return AAX_eStemFormat_9_1_4;
    if (set == AudioChannelSet::create9point0point6())
        return AAX_eStemFormat_9_0_6;
    if (set == AudioChannelSet::create9point1point6())
        return AAX_eStemFormat_9_1_6;
#endif
...
static inline AudioChannelSet
channelSetFromStemFormat(AAX_EStemFormat format, bool ignoreLayout) noexcept
{
    if (!ignoreLayout)
    {
        switch (format)
        {
            ...
            case AAX_eStemFormat_5_0_2:
                return AudioChannelSet::create5point0point2();
            case AAX_eStemFormat_5_1_2:
                return AudioChannelSet::create5point1point2();
            case AAX_eStemFormat_5_0_4:
                return AudioChannelSet::create5point0point4();
            ...
            case AAX_eStemFormat_9_0_4:
                return AudioChannelSet::create9point0point4();
            case AAX_eStemFormat_9_1_4:
                return AudioChannelSet::create9point1point4();
            case AAX_eStemFormat_9_0_6:
                return AudioChannelSet::create9point0point6();
            case AAX_eStemFormat_9_1_6:
                return AudioChannelSet::create9point1point6();
            case AAX_eStemFormat_Ambi_4_ACN:
                return AudioChannelSet::ambisonic(4);
            case AAX_eStemFormat_Ambi_5_ACN:
                return AudioChannelSet::ambisonic(5);
            case AAX_eStemFormat_Ambi_6_ACN:
                return AudioChannelSet::ambisonic(6);
            case AAX_eStemFormat_Ambi_7_ACN:
                return AudioChannelSet::ambisonic(7);
#else
...
static AAX_EMeterType
getMeterTypeForCategory(AudioProcessorParameter::Category category)
{
    switch (category)
    {
        ...
        case AudioProcessorParameter::expanderGateGainReductionMeter:
            return AAX_eMeterType_EGGain;
        case AudioProcessorParameter::analysisMeter:
            return AAX_eMeterType_Analysis;
...
static Colour
getColourFromHighlightEnum(AAX_EHighlightColor colour) noexcept
{
    switch (colour)
    {
...
static int
juceChannelIndexToAax(int juceIndex, const AudioChannelSet& channelSet)
{
    ...
    for (layoutIndex = 0;
         aaxChannelOrder[layoutIndex].aaxStemFormat != currentLayout;
         ++layoutIndex)
        if (aaxChannelOrder[layoutIndex].aaxStemFormat == 0)
            return juceIndex;
    ...
    const auto it = std::find(
      std::cbegin(speakerOrder), std::cend(speakerOrder), channelType);
...
{
    PluginInstanceInfo(JuceAAX_Processor& p)
      : parameters(p)
    {
    }
...
#if JucePlugin_ProducesMidiOutput || JucePlugin_IsSynth ||                     \
...
struct JUCEAlgorithmIDs
{
  ...
  JucePlugin_IsMidiEffect
        ...
        meterTapBuffers =
          AAX_FIELD_INDEX(JUCEAlgorithmContext, meterTapBuffers),

        sideChainBuffers =
          AAX_FIELD_INDEX(JUCEAlgorithmContext, sideChainBuffers)
    };
};

#if JucePlugin_WantsMidiInput || JucePlugin_IsMidiEffect
static AAX_IMIDINode*
getMidiNodeIn(const JUCEAlgorithmContext& c) noexcept
{
    return c.midiNodeIn;
}
#else
static AAX_IMIDINode*
getMidiNodeIn(const JUCEAlgorithmContext&) noexcept
{
    return nullptr;
}
#endif
...
AAX_IMIDINode* midiNodeOut;
static AAX_IMIDINode*
getMidiNodeOut(const JUCEAlgorithmContext& c) noexcept
{
    return c.midiNodeOut;
}
#else
static AAX_IMIDINode*
getMidiNodeOut(const JUCEAlgorithmContext&) noexcept
{
    return nullptr;
}
#endif
  ...
  , public ModifierKeyProvider
{
  public:
        ...
        if (void* nativeViewToAttachTo = GetViewContainerPtr())
        {
...
#endif
            {
                ...
                component->addToDesktop(
                  detail::PluginUtilities::getDesktopFlags(
                    component->pluginEditor.get()),
                  nativeViewToAttachTo);

                if (ModifierKeyReceiver* modReceiver =
                      dynamic_cast<ModifierKeyReceiver*>(component->getPeer()))
    ...
    AAX_Result GetViewSize(AAX_Point* viewSize) const override
    {
        if (component != nullptr)
        {
            *viewSize = convertToHostBounds(
              { (float)component->getHeight(), (float)component->getWidth() });
    ...
    AAX_Result ParameterUpdated(AAX_CParamID) override { return AAX_SUCCESS; }

    AAX_Result SetControlHighlightInfo(AAX_CParamID paramID,
                                       AAX_CBoolean isHighlighted,
                                       AAX_EHighlightColor colour) override
    {
    ...
    int getWin32Modifiers() const override
    {
        ...
        if (auto* viewContainer = GetViewContainer())
        {
            ...
            const_cast<AAX_IViewContainer*>(viewContainer)
              ->GetModifiers(&aaxViewMods);

            if ((aaxViewMods & AAX_eModifiers_Shift) != 0)
                modifierFlags |= ModifierKeys::shiftModifier;
            if ((aaxViewMods & AAX_eModifiers_Alt) != 0)
                modifierFlags |= ModifierKeys::altModifier;
        }
  ...
  private:
    ...
    struct ContentWrapperComponent final : public Component
    {
        ...
        void callMouseMethod(const MouseEvent& e, MethodType method)
        {
            ...
            {
                auto parameterIndex =
                  pluginEditor->getControlParameterIndex(*e.eventComponent);

                if (auto aaxParamID =
                      owner.getAAXParamIDFromJuceIndex(parameterIndex))
                {
                    uint32_t mods = 0;
        ...
        void childBoundsChanged(Component*) override
        {
            ...
            {
                pluginEditor->setBoundsConstrained(
                  pluginEditor->getBounds().withSize(
                    lastValidSize.getWidth(), lastValidSize.getHeight()));
            }
        }
        ...
        bool resizeHostWindow()
        {
            ...
            {
                auto newSize =
                  convertToHostBounds({ (float)pluginEditor->getHeight(),
                                        (float)pluginEditor->getWidth() });

                return owner.GetViewContainer()->SetViewSize(newSize) ==
                       AAX_SUCCESS;
            }
...
// Copied here, because not all versions of the AAX SDK define all of these
// values
...
static void AAX_CALLBACK
algorithmProcessCallback(JUCEAlgorithmContext* const instancesBegin[],
                         const void* const instancesEnd);

static Array<JuceAAX_Processor*> activeProcessors;

//==============================================================================
class JuceAAX_Processor final
  ...
  , private AsyncUpdater
{
  public:
    JuceAAX_Processor()
      : pluginInstance(
          createPluginFilterOfType(AudioProcessor::wrapperType_AAX))
    {
    ...
    static AAX_CEffectParameters* AAX_CALLBACK Create()
    {
        ...
        {
            PluginHostType::jucePlugInIsRunningInAudioSuiteFn =
    ...
    AAX_Result GetChunkIDFromIndex(int32_t index,
                                   AAX_CTypeID* chunkID) const override
    {
    ...
    AAX_Result GetChunk(AAX_CTypeID chunkID,
                        AAX_SPlugInChunk* oChunk) const override
    {
        if (chunkID != juceChunkType)
        ...
        chunkMemoryBlock.data.copyTo(
          oChunk->fData, 0, chunkMemoryBlock.data.getSize());
        chunkMemoryBlock.isValid = false;

        return AAX_SUCCESS;
    }

    AAX_Result SetChunk(AAX_CTypeID chunkID,
                        const AAX_SPlugInChunk* chunk) override
    {
        if (chunkID != juceChunkType)
        ...
        // * A preset is saved with the RTAS version of the plugin (".tfx"
        // preset format).
        // * The preset is loaded in PT 10 using the AAX version.
        // * The session is then saved, and closed.
        // * The saved session is loaded, but acting as if the preset was never
        // loaded. IMPORTANT! If the plugin doesn't manage its own bypass
        // parameter, don't try to overwrite the bypass parameter value.
            ...
            if (auto* juceParam = juceParameters.getParamForIndex(i))
                if (juceParam != ownedBypassParameter.get())
                    if (auto paramID = getAAXParamIDFromJuceIndex(i))
                        SetParameterNormalizedValue(paramID,
                                                    juceParam->getValue());

        return AAX_SUCCESS;
    }

    AAX_Result ResetFieldData(AAX_CFieldIndex fieldIndex,
                              void* data,
                              uint32_t dataSize) const override
    {
        switch (fieldIndex)
        {
            case JUCEAlgorithmIDs::pluginInstance:
            {
                ...
                jassert(numObjects ==
                        1); // not sure how to handle more than one..

                for (size_t i = 0; i < numObjects; ++i)
                    new (objects + i)
                      PluginInstanceInfo(const_cast<JuceAAX_Processor&>(*this));
    ...
    {
        const auto result =
          AAX_CEffectParameters::GetNumberOfChanges(numChanges);
    ...
    {
        auto result = AAX_CEffectParameters::UpdateParameterNormalizedValue(
        ...
        m_dirtyParamMap[paramID] = std::pair<bool, double>{ true, value };
    ...
    AAX_Result GenerateCoefficients() override
    {
        ...
        std::vector<std::pair<std::string, double>> updatedParams;

        for (auto& entry : m_dirtyParamMap)
        {
            if (entry.second.first)
            {
                entry.second.first = false;
                updatedParams.emplace_back(entry.first, entry.second.second);
            }
        }
    ...
    AAX_Result GetParameterStringFromValue(AAX_CParamID paramID,
                                           double value,
                                           AAX_IString* result,
    ...
    AAX_Result GetParameterNumberOfSteps(AAX_CParamID paramID,
    ...
    AAX_Result GetParameterNormalizedValue(AAX_CParamID paramID,
    ...
    AAX_Result SetParameterNormalizedValue(AAX_CParamID paramID,
    ...
    AAX_Result SetParameterNormalizedRelative(AAX_CParamID paramID,
    ...
    AAX_Result GetParameterNameOfLength(AAX_CParamID paramID,
                                        AAX_IString* result,
                                        int32_t maxLen) const override
    {
        if (auto* param = getParameterFromID(paramID))
    ...
    AAX_Result GetParameterName(AAX_CParamID paramID,
    ...
    AAX_Result GetParameterDefaultNormalizedValue(AAX_CParamID paramID,
                                                  double* result) const override
    {
        if (auto* param = getParameterFromID(paramID))
    ...
    Optional<PositionInfo> getPosition() const override
    {
        ...
        info.setBpm(
          [&]
          {
              ...
              return transport.GetCurrentTempo(&bpm) == AAX_SUCCESS
                       ? makeOptional(bpm)
                       : nullopt;
          }());
        ...
        info.setIsPlaying(
          [&]
          {
              ...
              return transport.IsTransportPlaying(&isPlaying) == AAX_SUCCESS &&
                     isPlaying;
          }());
        ...
        const auto optionalTimeInSamples = [&info, &transport]
        {
            ...
            return ((!info.getIsPlaying() &&
                     transport.GetTimelineSelectionStartPosition(
                       &timeInSamples) == AAX_SUCCESS) ||
                    transport.GetCurrentNativeSampleLocation(&timeInSamples) ==
                      AAX_SUCCESS)
        ...
        info.setTimeInSeconds((float)optionalTimeInSamples.orFallback(0) /
                              sampleRate);
        ...
        const auto tickPosition = [&]
        {
            ...
            return ((info.getIsPlaying() &&
                     transport.GetCustomTickPosition(
                       &ticks, optionalTimeInSamples.orFallback(0))) ==
                    AAX_SUCCESS) ||
        ...
        info.setPpqPosition(
          tickPosition.hasValue()
            ? makeOptional(static_cast<double>(*tickPosition) / 960'000.0)
            : nullopt);
        ...
        if (transport.GetCurrentLoopPosition(
              &isLooping, &loopStartTick, &loopEndTick) == AAX_SUCCESS)
        {
            info.setIsLooping(isLooping);
            info.setLoopPoints(LoopPoints{ (double)loopStartTick / 960000.0,
                                           (double)loopEndTick / 960000.0 });
        }
        ...
        const auto timeCodeIfAvailable = [&]() -> std::optional<RateAndOffset>
        {
            ...
            if (transport.GetHDTimeCodeInfo(&result.frameRate,
                                            &result.offset) == AAX_SUCCESS)
                return result;

            int32_t offset32{};

            if (transport.GetTimeCodeInfo(&result.frameRate, &offset32) ==
                AAX_SUCCESS)
            {
        ...
        if (timeCodeIfAvailable.has_value())
        {
            info.setFrameRate(
              [&]() -> Optional<FrameRate>
              {
                  ...
                  {
                      case JUCE_AAX_eFrameRate_24Frame:
                          return FrameRate().withBaseRate(24);
                      case JUCE_AAX_eFrameRate_23976:
                          return FrameRate().withBaseRate(24).withPullDown();

                      case JUCE_AAX_eFrameRate_25Frame:
                          return FrameRate().withBaseRate(25);

                      case JUCE_AAX_eFrameRate_30NonDrop:
                          return FrameRate().withBaseRate(30);
                      case JUCE_AAX_eFrameRate_30DropFrame:
                          return FrameRate().withBaseRate(30).withDrop();
                      case JUCE_AAX_eFrameRate_2997NonDrop:
                          return FrameRate().withBaseRate(30).withPullDown();
                      case JUCE_AAX_eFrameRate_2997DropFrame:
                          return FrameRate()
                            .withBaseRate(30)
                            .withPullDown()
                            .withDrop();

                      case JUCE_AAX_eFrameRate_48Frame:
                          return FrameRate().withBaseRate(48);
                      case JUCE_AAX_eFrameRate_47952:
                          return FrameRate().withBaseRate(48).withPullDown();

                      case JUCE_AAX_eFrameRate_50Frame:
                          return FrameRate().withBaseRate(50);

                      case JUCE_AAX_eFrameRate_60NonDrop:
                          return FrameRate().withBaseRate(60);
                      case JUCE_AAX_eFrameRate_60DropFrame:
                          return FrameRate().withBaseRate(60).withDrop();
                      case JUCE_AAX_eFrameRate_5994NonDrop:
                          return FrameRate().withBaseRate(60).withPullDown();
                      case JUCE_AAX_eFrameRate_5994DropFrame:
                          return FrameRate()
                            .withBaseRate(60)
                            .withPullDown()
                            .withDrop();

                      case JUCE_AAX_eFrameRate_100Frame:
                          return FrameRate().withBaseRate(100);

                      case JUCE_AAX_eFrameRate_120NonDrop:
                          return FrameRate().withBaseRate(120);
                      case JUCE_AAX_eFrameRate_120DropFrame:
                          return FrameRate().withBaseRate(120).withDrop();
                      case JUCE_AAX_eFrameRate_11988NonDrop:
                          return FrameRate().withBaseRate(120).withPullDown();
                      case JUCE_AAX_eFrameRate_11988DropFrame:
                          return FrameRate()
                            .withBaseRate(120)
                            .withPullDown()
                            .withDrop();

                      case JUCE_AAX_eFrameRate_Undeclared:
                          break;
                  }
        ...
        const auto offset        = timeCodeIfAvailable.has_value()
                                     ? (double)timeCodeIfAvailable->offset
                                     : 0.0;
        const auto effectiveRate = info.getFrameRate().hasValue()
                                     ? info.getFrameRate()->getEffectiveRate()
                                     : 0.0;
        info.setEditOriginTime(
          makeOptional(effectiveRate != 0.0 ? offset / effectiveRate : offset));

        {
            ...
            if (optionalTimeInSamples.hasValue() &&
                transport.GetBarBeatPosition(
                  &bars, &beats, &displayTicks, *optionalTimeInSamples) ==
                  AAX_SUCCESS)
            {
                ...
                {
                    const auto ticksSinceBar =
                      static_cast<int64_t>(((beats - 1) * 4 * 960'000) /
                                           signature->denominator) +
                      displayTicks;

                    if (tickPosition.hasValue() &&
                        ticksSinceBar <= tickPosition)
                    {
                        const auto barStartInTicks =
                          static_cast<double>(*tickPosition - ticksSinceBar);
                        info.setPpqPositionOfLastBarStart(barStartInTicks /
                                                          960'000.0);
                    }
                }
            }
                               ...
                               const ChangeDetails& details) override
    {
        ...
        if (details.parameterInfoChanged)
        {
            for (const auto* param : juceParameters)
                if (auto* aaxParam = mParameterManager.GetParameterByID(
                      getAAXParamIDFromJuceIndex(param->getParameterIndex())))
                    syncParameterAttributes(aaxParam, param);
        }

        if (details.latencyChanged)
            check(
              Controller()->SetSignalLatency(processor->getLatencySamples()));

        if (details.nonParameterStateChanged)
            ++numSetDirtyCalls;
    }

    void audioProcessorParameterChangeGestureBegin(AudioProcessor*,
    ...
    AAX_Result NotificationReceived(AAX_CTypeID type,
                                    const void* data,
                                    uint32_t size) override
    {
        switch (type)
        {
            ...
            case AAX_eNotificationEvent_ASProcessingState:
            {
                ...
                {
                    const auto state =
                      *static_cast<const AAX_EProcessingState*>(data);
                    const auto nonRealtime =
            ...
            case AAX_eNotificationEvent_TrackNameChanged:
                if (data != nullptr)
                {
                    ...
                    props.name = String::fromUTF8(
                      static_cast<const AAX_IString*>(data)->Get());
            ...
            case AAX_eNotificationEvent_SideChainBeingDisconnected:
            {
                ...
                sidechainDesired =
                  (type == AAX_eNotificationEvent_SideChainBeingConnected);
            ...
            case AAX_eNotificationEvent_TransportStateChanged:
                ...
                {
                    const auto& info =
                      *static_cast<const AAX_TransportStateInfo_V1*>(data);
    ...
    const float* getAudioBufferForInput(const float* const* inputs,
                                        int sidechain,
                                        int mainNumIns,
                 ...
                 float* const meterBuffers)
    {
        ...
        else
        {
            ...
            auto sidechain  = (pluginInstance->getChannelCountOfBus(true, 1) > 0
                                 ? sideChainBufferIdx
                                 : -1);
            ...
            if (channelList.size() <= numChans)
                channelList.insertMultiple(
                  -1, nullptr, 1 + numChans - channelList.size());
            ...
            if (numOuts >= numIns)
            {
                ...
                for (int i = 0; i < numIns; ++i)
                    memcpy(
                      channels[i],
                      getAudioBufferForInput(inputs, sidechain, mainNumIns, i),
    ...
    //==============================================================================
    // In aax, the format of the aux and sidechain buses need to be fully
    // determined by the format on the main buses. This function tried to
    // provide such a mapping. Returns false if the in/out main layout is not
    // supported
    static bool fullBusesLayoutFromMainLayout(
      const AudioProcessor& p,
      const AudioChannelSet& mainInput,
      const AudioChannelSet& mainOutput,
      AudioProcessor::BusesLayout& fullLayout)
    {
        auto currentLayout = getDefaultLayout(p, true);
        [[maybe_unused]] bool success =
          p.checkBusesLayoutSupported(currentLayout);
        jassert(success);
        ...
        if (numInputBuses > 0 &&
            currentLayout.inputBuses.getReference(0) != mainInput)
            return false;
        ...
        bool foundValid = false;
        {
            ...
            for (int i = 1; i < numInputBuses; ++i)
                onlyMains.inputBuses.getReference(i) =
                  AudioChannelSet::disabled();

            for (int i = 1; i < numOutputBuses; ++i)
                onlyMains.outputBuses.getReference(i) =
                  AudioChannelSet::disabled();
        ...
        if (numInputBuses > 1)
        {
            // can the first bus be a sidechain or disabled, if not then we
            // can't use this layout combination
            if (auto* bus = p.getBus(true, 1))
                if (!bus->isLayoutSupported(AudioChannelSet::mono(),
                                            &currentLayout) &&
                    !bus->isLayoutSupported(AudioChannelSet::disabled(),
                                            &currentLayout))
                    return foundValid;

            // can all the other inputs be disabled, if not then we can't use
            // this layout combination
            for (int i = 2; i < numInputBuses; ++i)
                if (auto* bus = p.getBus(true, i))
                    if (!bus->isLayoutSupported(AudioChannelSet::disabled(),
                                                &currentLayout))
                        return foundValid;
            ...
            if ((numInputBuses > 0 &&
                 currentLayout.inputBuses.getReference(0) != mainInput) ||
                (numOutputBuses > 0 &&
                 currentLayout.outputBuses.getReference(0) != mainOutput))
                return foundValid;

            auto& sidechainBus = currentLayout.inputBuses.getReference(1);

            if (sidechainBus != AudioChannelSet::mono() &&
                sidechainBus != AudioChannelSet::disabled())
                return foundValid;
        ...
        const bool hasSidechain =
          (numInputBuses > 1 &&
           currentLayout.inputBuses.getReference(1) == AudioChannelSet::mono());
        ...
        if (hasSidechain)
        {
            ...
            for (int i = 1; i < numOutputBuses; ++i)
                onlyMainsAndSidechain.outputBuses.getReference(i) =
                  AudioChannelSet::disabled();
        ...
        if (numOutputBuses > 1)
        {
            ...
            else
            {
                ...
                {
                    auto& sidechainBus =
                      currentLayout.inputBuses.getReference(1);
  ...
  private:
    ...
    friend void AAX_CALLBACK AAXClasses::algorithmProcessCallback(
      JUCEAlgorithmContext* const instancesBegin[],
      const void* const instancesEnd);
    ...
    void process(float* const* channels,
                 ...
                 const int bufferSize,
                 const bool bypass,
                 [[maybe_unused]] AAX_IMIDINode* midiNodeIn,
                 [[maybe_unused]] AAX_IMIDINode* midiNodesOut)
    {
...

        {
            if (lastBufferSize != bufferSize)
            {
                ...
                pluginInstance->setRateAndBufferSizeDetails(sampleRate,
                                                            lastBufferSize);

                // we only call prepareToPlay here if the new buffer size is
                // larger than the one used last time prepareToPlay was called.
                // currently, this should never actually happen, because as of
                // Pro Tools 12, the maximum possible value is 1024, and we call
                // prepareToPlay with that value during initialisation.
                if (bufferSize > maxBufferSize)
                    prepareProcessorWithSampleRateAndBufferSize(sampleRate,
                                                                bufferSize);
            }
...
#if JucePlugin_ProducesMidiOutput || JucePlugin_IsMidiEffect
        {
            ...
            {
                jassert(
                  isPositiveAndBelow(metadata.samplePosition, bufferSize));
                ...
                if (metadata.numBytes <= 4)
                {
                    ...
                    memcpy(
                      packet.mData, metadata.data, (size_t)metadata.numBytes);
    ...
    // parameter steps.
    static int32_t getSafeNumberOfParameterSteps(
    ...
    void addAudioProcessorParameters()
    {
        ...
        {
            ownedBypassParameter.reset(new AudioParameterBool(
              cDefaultMasterBypassID, "Master Bypass", false));
        ...
        for (const auto [parameterIndex, juceParam] : enumerate(juceParameters))
        {
            ...
            auto paramID  = isBypassParameter
                              ? String(cDefaultMasterBypassID)
                              : juceParameters.getParamID(audioProcessor,
                                                         (int)parameterIndex);

            aaxParamIDs.add(paramID);
            auto* aaxParamID =
              aaxParamIDs.getReference((int)parameterIndex).toRawUTF8();
            ...
            parameter->SetType(parameterNumSteps > 1000
                                 ? AAX_eParameterType_Continuous
                                 : AAX_eParameterType_Discrete);
#else
            parameter->SetType(juceParam->isDiscrete()
                                 ? AAX_eParameterType_Discrete
                                 : AAX_eParameterType_Continuous);
#endif

            parameter->SetOrientation(
              juceParam->isOrientationInverted()
            ...
            if (isBypassParameter)
                mPacketDispatcher.RegisterPacket(aaxParamID,
                                                 JUCEAlgorithmIDs::bypass);
        }
    }

    bool getMainBusFormats(AudioChannelSet& inputSet,
                           AudioChannelSet& outputSet)
    {
        ...
        inputSet =
          (inputBuses > 0 ? channelSetFromStemFormat(inputStemFormat, false)
                          : AudioChannelSet());
        outputSet =
          (outputBuses > 0 ? channelSetFromStemFormat(outputStemFormat, false)
                           : AudioChannelSet());

        if ((inputSet == AudioChannelSet::disabled() &&
             inputStemFormat != AAX_eStemFormat_None) ||
            (outputSet == AudioChannelSet::disabled() &&
             outputStemFormat != AAX_eStemFormat_None) ||
    ...
    AAX_Result preparePlugin()
    {
        ...
        if (!fullBusesLayoutFromMainLayout(
              audioProcessor, inputSet, outputSet, newLayout))
        {
            if (isPrepared)
            {
                isPrepared = false;
        ...
        if (hasSidechain)
        {
            ...
            disabledSidechainLayout.inputBuses.getReference(1) =
              AudioChannelSet::disabled();

            canDisableSidechain =
              audioProcessor.checkBusesLayoutSupported(disabledSidechainLayout);
        ...
        if (isInAudioSuite())
        {
            ...
            for (int i = 1; i < newLayout.outputBuses.size(); ++i)
                newLayout.outputBuses.getReference(i) =
                  AudioChannelSet::disabled();

            if (!audioProcessor.checkBusesLayoutSupported(newLayout))
            {
                // your plug-in needs to support a single output bus if running
                // in AudioSuite
                jassertfalse;
        ...
        check(
          Controller()->SetSignalLatency(audioProcessor.getLatencySamples()));
        isPrepared = true;
    ...
    void rebuildChannelMapArrays()
    {
        ...
        for (int dir = 0; dir < 2; ++dir)
        {
            ...
            {
                auto channelFormat =
                  audioProcessor.getChannelLayoutOfBus(isInput, busIdx);
                ...
                if (channelFormat != AudioChannelSet::disabled())
                {
                    ...
                    for (int ch = 0; ch < numChannels; ++ch)
                        layoutMap.add(juceChannelIndexToAax(ch, channelFormat) +
                                      chOffset);
    ...
    static void algorithmCallback(JUCEAlgorithmContext* const instancesBegin[],
                                  const void* const instancesEnd)
    {
        for (auto iter = instancesBegin; iter < instancesEnd; ++iter)
        {
            ...
            float* const meterTapBuffers =
              (i.meterTapBuffers != nullptr && numMeters > 0
                 ? *i.meterTapBuffers
                 : nullptr);
    ...
    void updateSidechainState()
    {
        ...
        auto& audioProcessor = getPluginInstance();
        const auto sidechainActual =
          audioProcessor.getChannelCountOfBus(true, 1) > 0;

        if (hasSidechain && canDisableSidechain &&
            sidechainDesired != sidechainActual)
        {
            ...
            if (auto* bus = audioProcessor.getBus(true, 1))
                bus->setCurrentLayout(lastSideChainState
                                        ? AudioChannelSet::mono()
                                        : AudioChannelSet::disabled());

            prepareProcessorWithSampleRateAndBufferSize(
              audioProcessor.getSampleRate(), maxBufferSize);
            isPrepared = true;
        }
    ...
    void handleAsyncUpdate() override { updateSidechainState(); }

    //==============================================================================
    static AudioProcessor::CurveData::Type aaxCurveTypeToJUCE(
      AAX_CTypeID type) noexcept
    {
        switch (type)
        {
            case AAX_eCurveType_EQ:
                return AudioProcessor::CurveData::Type::EQ;
            case AAX_eCurveType_Dynamics:
                return AudioProcessor::CurveData::Type::Dynamics;
            case AAX_eCurveType_Reduction:
                return AudioProcessor::CurveData::Type::GainReduction;
            default:
                break;
        }
    ...
    uint32_t getAAXMeterIdForParamId(const String& paramID) const noexcept
    {
        ...
        for (idx = 0; idx < aaxMeters.size(); ++idx)
            if (LegacyAudioParameter::getParamID(aaxMeters[idx], false) ==
                paramID)
                break;

        // you specified a parameter id in your curve but the parameter does not
        // have the meter category
        jassert(idx < aaxMeters.size());
        return 'Metr' + static_cast<AAX_CTypeID>(idx);
    }

    //==============================================================================
    AAX_Result GetCurveData(AAX_CTypeID iCurveType,
                            const float* iValues,
                            uint32_t iNumValues,
                            float* oValues) const override
    {
    ...
    AAX_Result GetCurveDataMeterIds(AAX_CTypeID iCurveType,
                                    uint32_t* oXMeterId,
                                    uint32_t* oYMeterId) const override
    {
        auto curveType = aaxCurveTypeToJUCE(iCurveType);
        ...
        if (curveType != AudioProcessor::CurveData::Type::Unknown)
        {
            ...
            if (curve.curve && curve.xMeterID.isNotEmpty() &&
                curve.yMeterID.isNotEmpty())
            {
                if (oXMeterId != nullptr)
                    *oXMeterId = getAAXMeterIdForParamId(curve.xMeterID);
                if (oYMeterId != nullptr)
                    *oYMeterId = getAAXMeterIdForParamId(curve.yMeterID);
    ...
    AAX_Result GetCurveDataDisplayRange(AAX_CTypeID iCurveType,
                                        float* oXMin,
                                        float* oXMax,
                                        float* oYMin,
                                        float* oYMax) const override
    {
        auto curveType = aaxCurveTypeToJUCE(iCurveType);
        ...
        if (curveType != AudioProcessor::CurveData::Type::Unknown)
        {
            ...
            {
                if (oXMin != nullptr)
                    *oXMin = curve.xRange.getStart();
                if (oXMax != nullptr)
                    *oXMax = curve.xRange.getEnd();
                if (oYMin != nullptr)
                    *oYMin = curve.yRange.getStart();
                if (oYMax != nullptr)
                    *oYMax = curve.yRange.getEnd();
    ...
    {
        if (auto* param = getParameterFromID(paramID))
            return LegacyAudioParameter::getParamIndex(getPluginInstance(),
                                                       param);
    ...
    AudioProcessorParameter* getParameterFromID(
      AAX_CParamID paramID) const noexcept
    {
        return paramMap[AAXClasses::getAAXParamHash(paramID)];
    }

    //==============================================================================
    static AudioProcessor::BusesLayout getDefaultLayout(const AudioProcessor& p,
                                                        bool enableAll)
    {
        ...
        for (int dir = 0; dir < 2; ++dir)
        {
            ...
            auto& layouts =
              (isInput ? defaultLayout.inputBuses : defaultLayout.outputBuses);

            for (int i = 0; i < numBuses; ++i)
                if (auto* bus = p.getBus(isInput, i))
                    layouts.add(enableAll || bus->isEnabledByDefault()
    ...
    void syncParameterAttributes(AAX_IParameter* aaxParam,
                                 const AudioProcessorParameter* juceParam)
    {
        ...
        {
            auto newType = juceParam->isDiscrete()
                             ? AAX_eParameterType_Discrete
                             : AAX_eParameterType_Continuous;
...

        {
            ...
            if (!approximatelyEqual(
                  static_cast<float>(aaxParam->GetNormalizedDefaultValue()),
                  defaultValue))
    ...
    bool hasSidechain = false, canDisableSidechain = false,
         lastSideChainState = false;

    /*  Pro Tools 2021 sends TransportStateChanged on the main thread, but we
       read the recording state on the audio thread. I'm not sure whether Pro
       Tools ensures that these calls are mutually exclusive, so to ensure there
       are no data races, we store the recording state in an atomic int and
       convert it to/from an Optional<bool> as necessary.
    */
    class RecordingState
    {
      public:
        /*  This uses Optional rather than std::optional for consistency with
         * get() */
        void set(const Optional<bool> newState)
        {
            state.store(newState.hasValue()
                          ? (flagValid | (*newState ? flagActive : 0))
                          : 0,
                        std::memory_order_relaxed);
        }

        /*  PositionInfo::setIsRecording takes an Optional<bool>, so we use that
           type rather than std::optional to avoid having to convert.
        */
        Optional<bool> get() const
        {
            const auto loaded = state.load(std::memory_order_relaxed);
            return ((loaded & flagValid) != 0)
                     ? makeOptional((loaded & flagActive) != 0)
                     : nullopt;
        }
...
//==============================================================================
void
JuceAAX_GUI::CreateViewContents()
{
    if (component == nullptr)
    {
        if (auto* params =
              dynamic_cast<JuceAAX_Processor*>(GetEffectParameters()))
            component.reset(
              new ContentWrapperComponent(*this, params->getPluginInstance()));
        else
            jassertfalse;
    }
}
...
int
JuceAAX_GUI::getParamIndexFromID(AAX_CParamID paramID) const noexcept
{
    if (auto* params =
          dynamic_cast<const JuceAAX_Processor*>(GetEffectParameters()))
...
AAX_CParamID
JuceAAX_GUI::getAAXParamIDFromJuceIndex(int index) const noexcept
{
    if (auto* params =
          dynamic_cast<const JuceAAX_Processor*>(GetEffectParameters()))
...
struct AAXFormatConfiguration
{
    ...
    AAXFormatConfiguration(AAX_EStemFormat inFormat,
                           AAX_EStemFormat outFormat) noexcept
...
//==============================================================================
static int
addAAXMeters(AudioProcessor& p, AAX_IEffectDescriptor& descriptor)
{
...
static void
createDescriptor(AAX_IComponentDescriptor& desc,
                 const AudioProcessor::BusesLayout& fullLayout,
                 AudioProcessor& processor,
                 Array<int32>& pluginIds,
                 const int numMeters)
{
    [[maybe_unused]] auto aaxInputFormat =
      getFormatForAudioChannelSet(fullLayout.getMainInputChannelSet(), false);
    [[maybe_unused]] auto aaxOutputFormat =
      getFormatForAudioChannelSet(fullLayout.getMainOutputChannelSet(), false);
...
#if JucePlugin_WantsMidiInput || JucePlugin_IsMidiEffect
    check(desc.AddMIDINode(JUCEAlgorithmIDs::midiNodeIn,
...
#if JucePlugin_ProducesMidiOutput || JucePlugin_IsSynth ||                     \
  JucePlugin_IsMidiEffect
    check(desc.AddMIDINode(JUCEAlgorithmIDs::midiNodeOut,
                           AAX_eMIDINodeType_LocalOutput,
                           JucePlugin_Name " Out",
                           0xffff));
#endif

    check(desc.AddPrivateData(JUCEAlgorithmIDs::pluginInstance,
                              sizeof(PluginInstanceInfo)));
    ...
    if (numMeters > 0)
    {
        ...
        check(desc.AddMeters(JUCEAlgorithmIDs::meterTapBuffers,
                             meterIDs.getData(),
                             static_cast<uint32_t>(numMeters)));
    }
    else
    {
        // AAX does not allow there to be any gaps in the fields of the
        // algorithm context structure so just add a dummy one here if there
        // aren't any meters
        check(desc.AddPrivateData(JUCEAlgorithmIDs::meterTapBuffers,
                                  sizeof(uintptr_t)));
    }

    check(desc.AddDataInPort(
      AAX_FIELD_INDEX(JUCEAlgorithmContext, renderStateCounter),
      sizeof(int64_t)));
    ...
    properties->AddProperty(AAX_eProperty_InputStemFormat,
                            static_cast<AAX_CPropertyValue>(aaxInputFormat));
    properties->AddProperty(AAX_eProperty_OutputStemFormat,
                            static_cast<AAX_CPropertyValue>(aaxOutputFormat));
    ...
    const auto pluginID = extensions.getPluginIDForMainBusConfig(
      fullLayout.getMainInputChannelSet(),
      fullLayout.getMainOutputChannelSet(),
      false);

    // The plugin id generated from your AudioProcessor's
    // getAAXPluginIDForMainBusConfig callback it not unique. Please fix your
    // implementation!
    ...
    properties->AddProperty(AAX_eProperty_PlugInID_AudioSuite,
                            extensions.getPluginIDForMainBusConfig(
                              fullLayout.getMainInputChannelSet(),
                              fullLayout.getMainOutputChannelSet(),
                              true));
#endif
    ...
    properties->AddProperty(AAX_eProperty_Constraint_DoNotApplyDefaultSettings,
                            true);
#endif
    ...
    else
    {
        // AAX does not allow there to be any gaps in the fields of the
        // algorithm context structure so just add a dummy one here if there
        // aren't any side chains
        check(desc.AddPrivateData(JUCEAlgorithmIDs::sideChainBuffers,
                                  sizeof(uintptr_t)));
    }
    ...
    for (int busIdx = 1; busIdx < maxAuxBuses + 1; ++busIdx)
    {
        ...
        if (auxFormat != AAX_eStemFormat_INT32_MAX &&
            auxFormat != AAX_eStemFormat_None)
        {
            auto& name = processor.getBus(false, busIdx)->getName();
            check(desc.AddAuxOutputStem(
              0, static_cast<int32_t>(auxFormat), name.toRawUTF8()));
        }
    }
...
static inline bool
hostSupportsStemFormat(AAX_EStemFormat stemFormat,
                       const AAX_IFeatureInfo* featureInfo)
{
    if (featureInfo != nullptr)
    {
        AAX_ESupportLevel supportLevel;

        if (featureInfo->SupportLevel(supportLevel) == AAX_SUCCESS &&
            supportLevel == AAX_eSupportLevel_ByProperty)
        {
            std::unique_ptr<const AAX_IPropertyMap> props(
              featureInfo->AcquireProperties());

            // Due to a bug in ProTools 12.8, ProTools thinks that
            // AAX_eStemFormat_Ambi_1_ACN is not supported To workaround this
            // bug, check if ProTools supports AAX_eStemFormat_Ambi_2_ACN, and,
            // if yes, we can safely assume that it will also support
            // AAX_eStemFormat_Ambi_1_ACN
            if (stemFormat == AAX_eStemFormat_Ambi_1_ACN)
                stemFormat = AAX_eStemFormat_Ambi_2_ACN;

            if (props != nullptr &&
                props->GetProperty((AAX_EProperty)stemFormat,
                                   (AAX_CPropertyValue*)&supportLevel) != 0)
...
static void
getPlugInDescription(AAX_IEffectDescriptor& descriptor,
                     [[maybe_unused]] const AAX_IFeatureInfo* featureInfo)
{
    ...
    if (const auto searchPath =
          extensions.getPageFileSearchPath().getFullPathName();
        searchPath.isNotEmpty())
        descriptor.AddResourceInfo(AAX_eResourceType_PageTableDir,
                                   searchPath.toRawUTF8());

    if (const auto filename = extensions.getPageFileName();
        filename.isNotEmpty())
        descriptor.AddResourceInfo(AAX_eResourceType_PageTable,
                                   filename.toRawUTF8());

    check(descriptor.AddProcPtr((void*)JuceAAX_GUI::Create,
                                kAAX_ProcPtrID_Create_EffectGUI));
    check(descriptor.AddProcPtr((void*)JuceAAX_Processor::Create,
    ...
    {
        createDescriptor(
          *desc, plugin->getBusesLayout(), *plugin, pluginIds, numMeters);
    ...
    for (int inIdx = 0; inIdx < jmax(numIns, 1); ++inIdx)
    {
        ...
        for (int outIdx = 0; outIdx < jmax(numOuts, 1); ++outIdx)
        {
                ...
                hostSupportsStemFormat(aaxOutFormat, featureInfo))
            {
                ...
                if (!JuceAAX_Processor::fullBusesLayoutFromMainLayout(
                      *plugin, inLayout, outLayout, fullLayout))
                    continue;

                if (auto* desc = descriptor.NewComponentDescriptor())
                {
                    createDescriptor(
                      *desc, fullLayout, *plugin, pluginIds, numMeters);
                    check(descriptor.AddComponent(desc));
                }
            }
        }
...
void AAX_CALLBACK
AAXClasses::algorithmProcessCallback(
  JUCEAlgorithmContext* const instancesBegin[],
  const void* const instancesEnd)
{
    AAXClasses::JuceAAX_Processor::algorithmCallback(instancesBegin,
                                                     instancesEnd);
}

//==============================================================================
AAX_Result JUCE_CDECL
GetEffectDescriptions(AAX_ICollection*);
AAX_Result JUCE_CDECL
GetEffectDescriptions(AAX_ICollection* collection)
{
    ScopedJuceInitialiser_GUI libraryInitialiser;
    ...
    if (const auto* hostDescription = collection->DescriptionHost())
        stemFormatFeatureInfo.reset(hostDescription->AcquireFeatureProperties(
          AAXATTR_ClientFeature_StemFormat));

    if (auto* descriptor = collection->NewDescriptor())
    {
        AAXClasses::getPlugInDescription(*descriptor,
                                         stemFormatFeatureInfo.get());
        collection->AddEffect(JUCE_STRINGIFY(JucePlugin_AAXIdentifier),
                              descriptor);
